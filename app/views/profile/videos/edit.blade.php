...
<body id="upldvideo-page">
    ...
    {{ Form::model($video, ['url'=> ['/video/create', $video->id],'method'=>'POST', 'files'=> true,'class'=>'text-center', 'enctype'=>'multipart/form-data'])}}
  ...
  <div class="modal-header">
      ...
      {{ Form::model($video, ['url'=> ['/video/art/create', $video->id],'method'=>'POST', 'files'=> true,'class'=>'text-center', 'enctype'=>'multipart/form-data'])}}
            ...
            <div class="row">
                    ...
                    <div class="col-md-6 form-group text-left">
                        <ul class="list-unstyled">
                            ...
                            <li><input placeholder="Type tags for your video here" class="form-control">
