...
<body>
    ...
    <div class="panel panel-default center-block upload-page">
     ...
     <form class="form-upload" id="upload" enctype="multipart/form-data" method="post" action="/gallery/create">
        ...
        <div class="panel-body">
            ...
            <div class="text-right">
               <!-- <input type="button" value="Upload File"> -->
                <input type="submit" id="submit-btn" value="Upload" onclick="uploadFile()"/>
